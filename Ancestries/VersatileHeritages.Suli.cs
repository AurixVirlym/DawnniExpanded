...
{
    public class VersatileHeritageSuli
    {
        ...
        public static Feat Heritage = new Feat(ModManager.RegisterFeatName("DE_Suli", "Suli"),
        ...
        public static Feat ElementalEmbellish = new TrueFeat(ModManager.RegisterFeatName("DE_ElementalEmbellish", "Elemental Embellish"), 1, "You can summon a harmless but impressive elemental display.", "You become trained in Intimidation. If you would automatically become trained in Intimidation (from your background or class, for example), you instead become trained in a skill of your choice.\n\nYou gain the Intimidating Glare feat.", new Trait[]
  {
        ...
        private static CombatAction ElementalAssaultAction(Creature creature, DamageKind dmgElement, Trait traitElement)
        {
            ...
            string ActionName = "Elemental Assault (" + ((Enum)traitElement).Humanize() + ")";
