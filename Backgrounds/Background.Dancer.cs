...
namespace Dawnsbury.Mods.DawnniExpanded.Backgrounds
{
    ...
    public class BackgroundDancer
    {
        ...
        public static void LoadMod()
        {
            ...
            DancerBackground = (new BackgroundSelectionFeat(ModManager.RegisterFeatName("DE_Dancer", "Dancer"), "In your younger days, you would dance, perhaps professionally, perhaps in private. Either way, this experience has proved valuable to your career as an adventurer."
