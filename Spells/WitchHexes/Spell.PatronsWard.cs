                    ...
                    Target.RangedFriend(6),
                        ...
                        .WithEffectOnEachTarget((Delegates.EffectOnEachTarget)(async (spell, caster, target, result) =>
                        {
                            ...
                            QEffect qeffectlifeboost = new QEffect()
                            {
                                ...
                                Name = "Patron's Ward",
                                Description = "You have a +1 status bonus to your saving throws and AC",
                                ...
                                BonusToDefenses = (QEffect effect, CombatAction attack, Defense defense) =>
                                    {
                                        ...
                                        {
                                            return new Bonus(1, BonusType.Status, "Patron's Ward");
                                        }
                                        else return null;
                            ...
                            caster.AddQEffect(SpellHexes.NamedSustaining(spell, qeffectlifeboost));
